...
ActiveRecord::Schema[7.0].define(version: 2022_09_02_133530) do
  ...
  create_table "favourites", force: :cascade do |t|
    ...
    t.index ["bookmark_id"], name: "index_favourites_on_bookmark_id"
  ...
  add_foreign_key "favourites", "bookmarks"
